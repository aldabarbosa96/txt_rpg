...
public class Tutorial {
    ...
    public static void tutorialEvent(GameContext gc) {//TUTORIAL
        ...
        gi.showMessage("En cristiano: si el guacho tiene 10 de defensa y tu tirada es 12(+1 de tu fuerza) = 13 --> le quitas 3 puntos de vida. En cambio, si tu tirada es de 8 perderías TÚ 1  punto de vida.\n" + "Esto se aplica igual a todo el mundo, por ahora.");
        gi.pauseForUserInput();
