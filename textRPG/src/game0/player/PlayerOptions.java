...
public class PlayerOptions {
    ...
    public static List<String> dialogar = new ArrayList<>();
     ...
     static {
        /*0*/dialogar.add("<<{PlayerName}>> : El único gilipollas que veo por aquí eres TÚ.");
        /*1*/dialogar.add("<<{PlayerName}>> : Procede a violentarle la mandíbula con los nudillos en un gesto rápido y efectivo.");
        /*2*/dialogar.add("<<{PlayerName}>> : Procede a enseñar su bolsa.");
        /*3*/dialogar.add("<<{PlayerName}>> : ¡Coño! ¡¿Solo tiene esto?! Menuda porquería.");
    }
}
