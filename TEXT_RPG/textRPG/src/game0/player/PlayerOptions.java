...
public class PlayerOptions {
    ...
    static {
        ...
        /*3*/opciones.add(Player.getName()+": Deberías ser más considerado con los pobres como yo.");   //esto parece que no debería ir aquí pero SÍ
        /*4*/opciones.add("A) La verdad que preferiría el tutorial de tontit@s\nB) Te reviento la cabeza\nC) Este juego es una mierda yo me voy");
