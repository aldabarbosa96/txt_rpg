...
public class GameStoryTeller { //NARRADOR
    ...
    static {
        ...
        /*9*/narracion.add("Narrador: Este DAAAAAADO sirve para que el jodido videojuego sea de <<ROL>>; es decir, cuando tengas un combate, un diálogo, o cualquier interacción con el mundo\nes posible que se te obligue a decidir tu suerte tirando LOS dados (efectivamente, tienes más de uno) para que tu destino dependa del AZAR.\nMe sigues, >>Caradeculo<< ? Digo, >>{PlayerName}<< ?");
        ...
        /*12*/narracion.add("Como habrás visto ya dispones de un DADO (en realidad son 2) en tu inventario, además de un comestible trozo de pan si fuiste bueno con el guardia (aaaaah te jodes si no lo fuiste parguela).");
        /*13*/narracion.add("¡Vamos a probar ese DADO! Primero que sepas que es un DADO algo mágico; puede tener 6 ó 12 caras (en realidad son 2 dados almacenados en el mismo espacio de memoria en el programa :)");
        /*14*/narracion.add("El DADO de 6 caras es para los diálogos. Ya verás su funcionamiento más adelante... Por ahora centrémonos en el DADO de ataque y simulemos un ataque.\nTú contra mí: ¡El pringao de >>{PlayerName}<< contra el maravilloso, el magnífico, el homnipotente y homnipresente NARRADOOORRRRRR!");
