...
public class GameStoryTeller { //NARRADOR
    ...
    static {
        ...
        /*15*/narracion.add("Bien, ahora que ya has visto el \"complejo\" sistema de lanzamiento de dados, quieres que te parta la boca ya o prefieres el T-U-T-O-R-I-A-L para T-O-N-T-I-T-O-S ?");
        ...
        /*21*/narracion.add("Narrador: Hay que ser pringao para perder contra mí JA JA JA...\nNo se yo si estás muy bien preparado para este basto mundo de violad..Digo, de peligros que acenchan.");
        ...
        /*31*/narracion.add("Narrador: Toma, te entrego esto:\n{PlayerName} ha recibido \"navaja multiusos\".");
        /*32*/narracion.add("Narrador: El Guardia de las Arenas golpea a "+Player.getName()+" con su maza de tungsteno y lo mata ipsofacto\n--------------------GAME OVER--------------------");
        /*33*/narracion.add("Narrador: "+ Player.getName() + " sale corriendo y tropieza con la sangre del guardia\nCon la cabeza en el frío suelo se percata de un objeto pequeño e insignificante (EL PUTO DADO).");
        ...
        /*37*/narracion.add("Narrador: No te falta razón, digo nos vemos >>"+Player.getName()+"<<.\n--------------------GAME OVER--------------------");
